...
-replace table_name with 'lime' and remove default seed ent
ries and replace with
-.then(function () {
-  const limes = [
-    {
...
-module.exports = require('knex')(config) // connect to db
via knexfile.js module.exports = { development ... }
-
...
-      res.render('all', { limes: limes }) // property : ar
ray of data from limes tbl/db
-    })
-})
